  ...
  return {
    files: [
      ...
      },
      {
        ...
        content: getSupabasePublicRuntimeSecret(namespace),
      },
      {
...
function getSupabasePublicRuntimeSecret(namespace: string) {
  return `apiVersion: v1
kind: Secret
metadata:
...
- \`Secret/supabase-public-runtime\`: browser-safe Supabase URL and anon key material.
